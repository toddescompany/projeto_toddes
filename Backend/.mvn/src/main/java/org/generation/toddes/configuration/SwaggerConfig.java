package org.generation.toddes.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("org.generation.toddes.controller"))
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
				.title("API - Projeto Toddes")
				.description("Projeto API Spring - Toddes")
				.version("1.0.0").license("Apache License Version 2.0")
				.licenseUrl("https://github.com/toddescompany")
				.contact(contact())
				.build();
	}
	...
	public static Contact contact() {
		...
		return new Contact("Toddes Company®", 
				"https://github.com/toddescompany", 
				"toddes.company@gmail.com");
	}
